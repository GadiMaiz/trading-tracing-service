// MIT License
// Copyright (c) 2017 Christian Fröhlingsdorf
// source code can be found  https://github.com/krystianity/node-bitstamp/
...
class Bitstamp {
  ...
  setCredentials( key, secret, clientId) {
    this.signature = new Signature(key, secret, clientId);
  }
  ...
  buyLimitOrder(amount, price, currency = null, limit_price = null, daily_order = null, ioc_order = null) {
  ...
  sellLimitOrder(amount, price, currency = null, limit_price = null, daily_order = null, ioc_order = null) {
    const ep = 'sell';
    const body = {
      amount,
      price,
